package edu.unc.mapseq.messaging.nec.mergebam;
...
public class NECMergeBAMMessagingService {

    private final Logger logger = LoggerFactory.getLogger(NECMergeBAMMessagingService.class);
    ...
    public NECMergeBAMMessagingService() {
        super();
    }
    ...
    public void start() throws Exception {
        ...
        NECMergeBAMMessageListener messageListener = new NECMergeBAMMessageListener();
