...
public class NECMergeBAMMessageListener extends AbstractMessageListener {

    private final Logger logger = LoggerFactory.getLogger(NECMergeBAMMessageListener.class);

    public NECMergeBAMMessageListener() {
        super();
    }
    ...
    public void onMessage(Message message) {
        ...
        String workflowName = "NECMergeBAM";
        try {
