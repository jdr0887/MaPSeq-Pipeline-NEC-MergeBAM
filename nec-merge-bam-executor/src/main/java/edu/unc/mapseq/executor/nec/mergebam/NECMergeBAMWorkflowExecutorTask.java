...
public class NECMergeBAMWorkflowExecutorTask extends TimerTask {
    ...
    public void run() {
        ...
        try {
            Workflow workflow = workflowDAO.findByName("NECMergeBAM");
            ...
            if (workflowPlanList != null && workflowPlanList.size() > 0) {
                ...
                for (WorkflowPlan workflowPlan : workflowPlanList) {
                    ...
                    workflowRun.setVersion(nidaUCSFMergeBAMWorkflow.getVersion());
                    ...
                    nidaUCSFMergeBAMWorkflow.setWorkflowPlan(workflowPlan);
